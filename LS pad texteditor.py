# -*- coding: utf-8 -*-
"""
Created on Tue Mar 10 22:18:30 2020
@CODER: LOKESH KUMAR
"""
#Module used
...
main_application.title('LS pad text editor')
...
clearall_icon=tk.PhotoImage(file='icons2\clear_all.png')
find_icon=tk.PhotoImage(file='icons2\\find.png')

edit=tk.Menu(main_menu,tearoff=False)

#view icons
toolbar_icon=tk.PhotoImage(file='icons2\\toolbar.png')
statusbar_icon=tk.PhotoImage(file='icons2\statusbar.png')
...
color_icons=(light_default_icon,light_plus_icon,dark_icon,night_blue_icon,red_icon,monokai_icon)
color_dict={
...
def find_func(event=None):
    ...
    def find():
        ...
        if word:
            ...
            while True:
                ...
                start_pos=end_pos
                text_editor.tag_config('match',foreground='red',background='cyan')
                matches+=1
    ...
    ##Entry grid
    text_find_entry.grid(row=0,column=1,padx=4,pady=5)
    text_replace_entry.grid(row=1,column=1,padx=4,pady=5)
...
#main_menu object configure and looping main_application.
